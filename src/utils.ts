...
const Utils = {
  ...
  initCommands ( context: vscode.ExtensionContext ) {
    ...
    const {commands} = vscode.extensions.getExtension ( 'fabiospampinato.vscode-open-in-ship' ).packageJSON.contributes;
  ...
  repo: {
    ...
    getGit ( repopath ) {
      ...
      return pify ( _.bindAll ( simpleGit ( repopath ), ['getRemotes'] ) );
